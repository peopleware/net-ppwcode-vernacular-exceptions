// Copyright 2010-2015 by PeopleWare NV.
// 
...
namespace PPWCode.Vernacular.Exceptions.I
{
    ...
    ///     </para>
    ///     <para>
    ///         The <see cref="Exception.Message" /> should express the error as closely as
    ///         possible.
    ...
    ///     </para>
    ///     <para>
    ///         These errors should not be mentioned in the exception part of a method contract.
    ...
    ///         implied that the database connection works).
    ///     </para>
    ///     <para>
    ///         It probably does not make sense to create subtypes of this error for specific
    ...
    ///     </para>
    ///     <para>
    ///         Some string class variables are provided, that can be used as <see cref="Exception.Message" />
    ///         if you wish. Using the same strings might help keep the code in your project
    ///         more consistent. The audience of these strings are system administrators.
    ///     </para>
    /// </remarks>
    [Serializable]
